namespace Topic_4_assignment
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            double roundedDiscountPrice, taxAdded, roundedTaxAdded, roundedAmountOff, finalPrice, roundedFinalPrice;
            ...
            roundedAmountOff = (double)Decimal.Round((decimal)amountOff, 2);
            ...
            Console.WriteLine("Price: " + "$" + priceOne);
            Console.WriteLine("Item 2: " + itemTwo);
            Console.WriteLine("Price: " + "$" + priceTwo);
            Console.WriteLine("==========================");
            Console.WriteLine("Total: " + totalPrice);
            Console.WriteLine("Discount (" + discount + "%): " + roundedAmountOff);
            Console.WriteLine("Subtotal: " + "$" + roundedDiscountPrice);
            taxAdded = (roundedDiscountPrice * 0.13);
            roundedTaxAdded = (double)Decimal.Round((decimal)taxAdded, 2);
            Console.WriteLine("Tax (13%): " + "$" + roundedTaxAdded);
            Console.WriteLine("==========================");
            finalPrice = roundedDiscountPrice + roundedTaxAdded;
            roundedFinalPrice = (double)Decimal.Round((decimal)finalPrice, 2);
            Console.WriteLine("Total owed: " + "$" + roundedFinalPrice);
